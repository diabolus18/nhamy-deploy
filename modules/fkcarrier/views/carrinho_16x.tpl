    ...
    <div class="opc-main-block">
        <div class="order_carrier_content box">
            <div class="delivery_options_address">
                <h3>
                    {l s='Informe o CEP para cálculo do frete do pedido' mod='fkcarrier'}
                </h3>
                ...
                <div class="delivery_options">
                    <div id="fkcarrier_cep_form">
                        <form action="#" method="post">
                            <input type="text" class="fkcarrier_text_cep" size="10" name="fkcarrier_cep_carrinho" value="{$fkcarrier_cep}"/>
                            <input type="submit" class="btn btn-default button button-medium" value="{l s='Calcular frete' mod='fkcarrier'}" name="submitCarrinho"/>
                        </form>
                    </div>
