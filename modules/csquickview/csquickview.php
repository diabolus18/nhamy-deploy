...
class CsQuickView extends Module
{
	...
	function install()
	{	
		if (!Configuration::updateValue('CS_QUICKVIEW_ITEM_SELECT',"a.product_img_link,a.product_image,a.content_img") || !parent::install()|| !$this->registerHook('header'))
			return false;
		Configuration::updateValue('CS_QUICKVIEW_RESIZE_TYPE',1);
		Configuration::updateValue('CS_QUICKVIEW_RESIZE_WIDTH',740);
		Configuration::updateValue('CS_QUICKVIEW_RESIZE_HEIGHT',550);
		return true;
	}
