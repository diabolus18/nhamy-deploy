...
function processaCEP(objcep, atlPostcode){
    ...
    $.post(urlFuncoes, {func: "1", cep: cep}, function(retorno) {
        ...
        if (retorno.length > 1) {
            ...
            if (arRet[0] == '0') {
                ...
                $("#address1").val($.trim(decodeURI(arRet[5])) + " " + $.trim(decodeURI(arRet[6])));
                $("#address2").val($.trim(decodeURI(arRet[4])));
                $("#city").val($.trim(decodeURI(arRet[3])));
                procUF($.trim(decodeURI(arRet[2])));
            }
        } else {
            msgCEP("2");
        }
...
function procBY(cep) {
    ...
    $.post(urlFuncoes, {func: "2", cep: cep, usuario: usuario, senha: senha}, function(retorno) {
...
function procAC(cep) {
    ...
    $.post(urlFuncoes, {func: "3", cep: cep, usuario: usuario, senha: senha}, function(retorno) {
        ...
        if (retorno.length > 1) {
            ...
            msgCEP("3");
            $("#address1").val($.trim(decodeURI(arRet[0])));
            $("#address2").val($.trim(decodeURI(arRet[1])));
            $("#city").val($.trim(decodeURI(arRet[2])));
            procUF($.trim(decodeURI(arRet[3])));
