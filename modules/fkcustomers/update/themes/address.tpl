...
*}
		...
		<p class="required text">
		    ...
		    <input type="text" class="text" name="numend" id="numend" value="{if isset($smarty.post.numend)}{$smarty.post.numend}{else}{if isset($address->numend)}{$address->numend|escape:'htmlall':'UTF-8'}{/if}{/if}" />
		</p>
		{/if}
{*
************************************************************************************************
...
*}
		...
		<p class="text">
    		...
    		<input type="text" class="text" name="compl" id="compl" value="{if isset($smarty.post.compl)}{$smarty.post.compl}{else}{if isset($address->compl)}{$address->compl|escape:'htmlall':'UTF-8'}{/if}{/if}" />
		</p>
		{/if}
{*
************************************************************************************************
...
*}
		...
		<p class="required text">
			<label for="address2">{l s='Bairro'}</label>
...
*}
		...
		<p class="required postcode text">
			...
			<input type="text" id="postcode" name="postcode" value="{if isset($smarty.post.postcode)}{$smarty.post.postcode}{else}{if isset($address->postcode)}{$address->postcode}{/if}{/if}" onblur="processaCEP(this);" />
			<span class="form_info" id="alertpostcode" name="alertpostcode"></span>
		</p>
{*
************************************************************************************************
* Final da altera??o para pesquisar CEP via webservice
************************************************************************************************
*}
		{/if}
