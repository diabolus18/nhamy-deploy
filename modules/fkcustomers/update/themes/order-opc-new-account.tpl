...
************************************************************************************************
*}
                <h3>{l s='Suas informações pessoais'}</h3>
{*
************************************************************************************************
...
*}
                ...
                <p class="required postcode text">
                    ...
                    <input type="text" class="text" name="postcode" id="postcode" value="{if isset($guestInformations) && $guestInformations.postcode}{$guestInformations.postcode}{/if}" onblur="processaCEP(this);" />
...
*}
                ...
                <p class="required text">
                    ...
                    <input type="text" class="text" name="numend" id="numend" value="{if isset($guestInformations) && $guestInformations.numend}{$guestInformations.numend}{/if}"/>
                </p>
{*
************************************************************************************************
* Final campo numero
...
*}
                ...
                <p class="text">
                    ...
                    <input type="text" class="text" name="compl" id="compl" value="{if isset($guestInformations) && $guestInformations.compl}{$guestInformations.compl}{/if}"/>
                </p>
{*
************************************************************************************************
