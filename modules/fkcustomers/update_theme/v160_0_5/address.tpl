	...
	<form action="{$link->getPageLink('address', true)|escape:'html':'UTF-8'}" method="post" class="std" id="add_address">
		...
		{foreach from=$ordered_adr_fields item=field_name}
			{if $field_name eq 'company'}
                ...
                {include file="$RealPath/includes/v160_0_5/company_address.tpl"}
            ...
            {include file="$RealPath/includes/v160_0_5/numend_address.tpl"}
            {*** FKcustomers - numend - fim ***}
            {*** FKcustomers - compl - inicio ***}
            {include file="$RealPath/includes/v160_0_5/compl_address.tpl"}
