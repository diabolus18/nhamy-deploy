		...
		<form action="{$link->getPageLink('authentication', true, NULL, "back=$back")|escape:'html':'UTF-8'}" method="post" id="new_account_form" class="std clearfix">
			<div class="box">
				<div id="opc_account_form" style="display: block; ">
                    ...
                    {include file="$RealPath/includes/v160_0_6/inf_fiscais_authentication.tpl"}
					...
					{foreach from=$dlv_all_fields item=field_name}
						{if $field_name eq "company" && $b2b_enable}
                            ...
                            {include file="$RealPath/includes/v160_0_6/company_authentication.tpl"}
						...
						{elseif $field_name eq "postcode"}
							...
							<div class="required postcode form-group">
                                ...
                                {include file="$RealPath/includes/v160_0_6/postcode.tpl"}
						...
						{/if}
                        {*** FKcustomers - numend - inicio ***}
                        {include file="$RealPath/includes/v160_0_6/numend_authentication.tpl"}
                        {*** FKcustomers - numend - fim ***}
                        {*** FKcustomers - compl - inicio ***}
                        {include file="$RealPath/includes/v160_0_6/compl_authentication.tpl"}
                        {*** FKcustomers - compl - fim ***}
					{/foreach}
