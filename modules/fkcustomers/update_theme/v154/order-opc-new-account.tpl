		...
		<fieldset>
            ...
            *}
			...
			<div id="opc_account_form">
                ...
                {include file="$RealPath/includes/v154/inf_fiscais_order_opc.tpl"}
                ...
                {include file="$RealPath/includes/v154/company_order_opc.tpl"}
				...
				{/if}
                    ...
                    {include file="$RealPath/includes/v154/numend_order_opc.tpl"}
                    {*** FKcustomers - numend - fim ***}
                    {*** FKcustomers - compl - inicio ***}
                    {include file="$RealPath/includes/v154/compl_order_opc.tpl"}
