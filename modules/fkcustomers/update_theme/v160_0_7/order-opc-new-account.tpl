	...
	<form action="{$link->getPageLink('authentication', true)|escape:'html'}" method="post" id="new_account_form" class="std" autocomplete="on" autofill="on">
		<fieldset>
        	<div class="box">
                ...
                {include file="$RealPath/includes/v160_0_7/inf_fiscais_order_opc.tpl"}
				...
				{if $field_name eq "company" && $b2b_enable}
                    ...
                    {include file="$RealPath/includes/v160_0_7/company_order_opc.tpl"}
                ...
                {include file="$RealPath/includes/v160_0_7/numend_order_opc.tpl"}
                {*** FKcustomers - numend - fim ***}
                {*** FKcustomers - compl - inicio ***}
                {include file="$RealPath/includes/v160_0_7/compl_order_opc.tpl"}
