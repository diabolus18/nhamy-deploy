		...
		<fieldset>
            ...
            *}
			...
			<div id="opc_account_form">
                ...
                {include file="$RealPath/includes/v156/inf_fiscais_order_opc.tpl"}
				...
				{if $field_name eq "company" && $b2b_enable}
                    ...
                    {include file="$RealPath/includes/v156/company_order_opc.tpl"}
				...
				{/if}
                    ...
                    {include file="$RealPath/includes/v156/numend_order_opc.tpl"}
                    {*** FKcustomers - numend - fim ***}
                    {*** FKcustomers - compl - inicio ***}
                    {include file="$RealPath/includes/v156/compl_order_opc.tpl"}
