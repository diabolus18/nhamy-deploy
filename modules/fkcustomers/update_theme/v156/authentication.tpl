...
{literal}
	...
	<form action="{$link->getPageLink('authentication', true, NULL, "back=$back")|escape:'html'}" method="post" id="new_account_form" class="std clearfix">
		<fieldset>
            ...
            {include file="$RealPath/includes/v156/inf_fiscais_authentication.tpl"}
			...
			<div id="opc_account_form" style="display: block; ">
				...
				{foreach from=$dlv_all_fields item=field_name}
					{if $field_name eq "company" && $b2b_enable}
                        ...
                        {include file="$RealPath/includes/v156/company_authentication.tpl"}
					...
					{assign var='postCodeExist' value=true}
						<p class="required postcode text">
                            ...
                            {include file="$RealPath/includes/v156/postcode.tpl"}
                    ...
                    {include file="$RealPath/includes/v156/numend_authentication.tpl"}
                    {*** FKcustomers - numend - fim ***}
                    {*** FKcustomers - compl - inicio ***}
                    {include file="$RealPath/includes/v156/compl_authentication.tpl"}
