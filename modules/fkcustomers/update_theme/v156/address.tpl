...
<form action="{$link->getPageLink('address', true)|escape:'html'}" method="post" class="std" id="add_address">
	...
	{foreach from=$ordered_adr_fields item=field_name}
		...
		{if $field_name eq 'company'}
            ...
            {include file="$RealPath/includes/v156/company_address.tpl"}
		...
		*}
        ...
        {include file="$RealPath/includes/v156/numend_address.tpl"}
        {*** FKcustomers - numend - fim ***}
        {*** FKcustomers - compl - inicio ***}
        {include file="$RealPath/includes/v156/compl_address.tpl"}
