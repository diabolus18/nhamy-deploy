...
{if !isset($email_create)}
	...
	<form action="{$link->getPageLink('authentication', true, NULL, "back=$back")|escape:'html'}" method="post" id="new_account_form" class="std clearfix">
		<fieldset>
            ...
            {include file="$RealPath/includes/v155/inf_fiscais_authentication.tpl"}
			...
			<div id="opc_account_form" style="display: block; ">
				...
				{foreach from=$dlv_all_fields item=field_name}
					{if $field_name eq "company"}
                        ...
                        {include file="$RealPath/includes/v155/company_authentication.tpl"}
						...
						<p class="required postcode text">
                            ...
                            {include file="$RealPath/includes/v155/postcode.tpl"}
                    ...
                    {include file="$RealPath/includes/v155/numend_authentication.tpl"}
                    {*** FKcustomers - numend - fim ***}
                    {*** FKcustomers - compl - inicio ***}
                    {include file="$RealPath/includes/v155/compl_authentication.tpl"}
